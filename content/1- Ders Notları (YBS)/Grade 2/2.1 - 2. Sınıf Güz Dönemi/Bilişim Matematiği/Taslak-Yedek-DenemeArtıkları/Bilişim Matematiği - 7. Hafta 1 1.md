...
$A = \begin{bmatrix} 2 & 3 \\ 1 & 2 \end{bmatrix} \implies A^{-1} = ?$
...
$\begin{bmatrix} -1 & 3 \\ 2 & -4 \end{bmatrix} \implies A^{-1} = ?$
...
### Örnek 1
Aşağıdaki denklemin çözüm kümesini Cramer yöntemiyle bulunuz.
