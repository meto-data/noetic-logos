...
cssclasses:
  - ders-notu
---
<h1 style="text-align:center"><span style="color:cyan; text-align:center">Ünite 4: Lineer Cebir (Matrisler ve Determinantlar)</span> | <span style="color:lightorange">07.11.2025</span></h2>
...
#### $\quad \to 2a +3c -(2a + 4c) = 1 \implies -c = 1 \to$
##### $\qquad c = -1$
#### $\quad \to 2b +3d -(2b + 4d) = -2 \implies -d = -2$
##### $\qquad d = 2$
#### $\quad \to a-2 = 0 \implies a = 2 \quad$
#### $\quad \to b +4 = 1 \implies b = -3$
...
#### $\quad \to b-2d = 1 \implies b = \frac{3}{2}$
