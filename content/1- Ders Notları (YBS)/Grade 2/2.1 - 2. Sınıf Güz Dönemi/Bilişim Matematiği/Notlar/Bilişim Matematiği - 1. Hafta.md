...
- **[[ATLAS/Depo/Linkler/Ekler 1/Bilişim Matematiği]]**: Bilgisayarın yazılım temelinde ikili sayma sistemi esas alınır (binary system, binary digit). Buna **[[boole cebri]]** denir. Doğru (T-True) ya da yanlış (F-False) mantıksal temelli işlemleri esas alır (dijital şebekeler, bellekler, işlemciler vb.).
