...
- Bilanço ve gelir tablolarındaki hesapları anlayabilmesi, malî analiz tekniklerini uygulayabilmesi,  işletme amaçlarını bilmesi ve politikaları anlayabilmesi yeterlidir.
- İki temel sorunla karşı karşıyadır:
...
- 
#### $\begin{aligned} GD_n &= BD \left(1 + \frac{i}{m}\right)^{n \times m} \\m &= \text{Bir yıldaki faiz ödeme sıklığı.} \end{aligned}$
