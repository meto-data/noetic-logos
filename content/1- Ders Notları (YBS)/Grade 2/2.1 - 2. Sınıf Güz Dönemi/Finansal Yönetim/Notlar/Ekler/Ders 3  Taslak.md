...
- döngü grafiği hakkında;
	-  Ana paradan gelecek değere gider g rafik
		...
		- Basit faizi hesapladığımız için faiz tutarını ana para $\times$ faiz oranı ile hesaplıyoruz. $\times$ vade falan da var, bakacağız daha sonra. Daha ziyade döngü bağlamında açıklamak gerekiyor bunu.
...
ÇEK POLİEÇDEN DAHA KIYMETLİ ÇÜNKÜ BANKA VAR ARADA, GÜVEN...
	KARA LİSTEYE GİRME DURUMU NASIL? ÇEKİN ÜZERİNDE YAZAN VADEYİ AYNI SINIRLAR İÇERİSİNDE 10 GÜN İÇİNDE Mİ ALABİLİYORUZ?
		ESNEKLİK SAĞLAMA DURUMU? NE SAĞLIYOR ESNEKLİĞİ? AYNI ÜLKE SINIRLARINDA 10 GÜN AYNI KITA 1 AY FARKLI KITALARDAYSA 3 AY MÜHLETİ VAR.
