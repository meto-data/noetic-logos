...
###### Satır sayısı = denklem sayısı = $n$
###### Sütun sayısı = bilinmeyen sayısı = $m$ 

#### $\begin{bmatrix} \space &&&& \\ \space &  \end{bmatrix}_{m \times n}$



- Matrisler `A`, `B`, `C` gibi büyük harfler ile isimlendirilir.

#### $A = \begin{bmatrix} 1 & 2 & 6 \\ 4 & 9 & 1  \\ 5 & 4 &6  \end{bmatrix}_{m \times n}$ Boyutu: $3 \times 3$ = $\boxed{\text{A}_{3 \times 3}}$


<br>

##### $\text{A }= \begin{bmatrix} a_{11} & b_{12} & c_{13} \\ d_{21} & e_{22} & f_{23}  \end{bmatrix}_{2 \times 3}$
