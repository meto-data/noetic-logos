...
2. Hâkim tarafından en fazla 4 haftaya kadar birer hafta şeklinde ek süre tanınabilir.
3. Elde edilen kanıtlar suç ile ilgili değil ise yok edilir.
4. Teknik araçlarla işleme, kişinin konutunda uygulanamaz.

---


**SEGBİS**: Ses ve görüntü sistemlerinin kullanılmasına dair mevcut olan yönetmelikte bir sorun işlenmesi ile ilgili olarak yürütülen soruşturma ve kavuşturma evresinde savcı, hakim ya da mahkeme tarafından dinlenmesi gereken kişiler, SEGBİS kullanılmak suretiyle;
	1. Dinlenilmesi
	2. Kayda alınması
	3. Saklanması
...
1. Tanımlanması (tanımlama)
2. Kanıtların toplanması ve korunması (toplama ve korunumu)
3. Bilgi teknolojileri ile elde edilen kanıtların analiz edilmesi (analiz)
