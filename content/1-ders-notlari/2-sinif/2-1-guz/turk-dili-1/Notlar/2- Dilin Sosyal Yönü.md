...
- Bir toplumun başka bir toplum üzerinde **siyasî bir egemenlik olmaksızın din, medeniyet veya kültür** alanlarında etkili olması sonucu ortaya çıkan dilsel değişimdir.
	- **Uygurların** Maniheizm ve Budizm'i benimsemeleriyle **Çince** ve **Sankritçe**den çok sayıda dinî terim ve kelime almaları.
...
- **Kültür**: (Lat. colere $\to$ cultura); tarım, üretme, yetiştirme.
...
- **Dil ve kültür ilişkisi örnekleri**:
	- Arapçada devenin rengini gösteren yüzlerce kelime $\to$ Arap toplumunun yaşam biçimi ve deve kültürüyle bağlantılı.
	- Türkçede at türleri ve renkleri $\to$ Türk toplumunun kültürel odakları.
	- Eskimolar $\to$ Karın türlerini ve durumlarını göstermek için yüzlerce ayrı kelime.
	- Atasözleri, deyimler ve argo söz dağarcığı $\to$ Toplumun değer yargıları ve kültürü hakkında ipuçları verir.
...
1. **Düşüncenin Dile Bağımlı Olduğunu Savunanlar**:
...
2. **Düşüncenin Dilden Bağımsız Olabileceğini Savunanlar**:        
