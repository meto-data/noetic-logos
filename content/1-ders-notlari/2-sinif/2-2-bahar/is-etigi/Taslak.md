...
**İnternet Sitesi**: **[zimemdefteri.com](https://zimemdefteri.com/)**

**Projenin Amacı**: Düzce Çilimli SYDV tarafından sosyo-ekonomik incelemeleri yapılmış dezavantajlı hanelerin yerel esnafa olan mikro borçlarını dijital bir altyapı üzerinden tamamen anonim olarak kapatmak. Proje kapsamında, bireyler arası hiyerarşik bir yardım ilişkisi kurmadan sadece sistem üzerinden belgelenebilir bir finansal itfa işlemi gerçekleştirilmeye çalışılmaktadır. Böylece hem hanelerin ekonomik darboğazdan çıkmalarına nesnel bir katkı sunulması hem de tahsilat zorluğu çeken mahalle esnafının nakit akışının rahatlatılması hedeflenmektedir.


## **Projenin Hedefleri**
1. Yardım eylemini yüz yüze temas kurmadan, dijital ve anonim bir süreçle tamamlamak. Nitekim birebir temas ile yapılan bu gibi eylemler karşı tarafın mahcup hissetmesine sebep olabilir.
2. Yerel bir kamu kurumu olan Çilimli SYDV projesini, öğrenci faaliyetleriyle elde edilen fonla destekleyerek sivil bir entegrasyon sağlamak.
3. İşlemlerin tamamını banka dekontları, internet sitesindeki loglarla vs. şeffaf bir biçimde  belgelendirmek.


## **Projenin Hedef Kitlesi ve Hedef Grup Üzerinde Beklenen Etkiler**
- **Hedef Kitle**: Çilimli SYDV kayıtlarında yer alan ihtiyaç sahibi haneler ve bu borçların ait olduğu yerel esnaf.
...
- Proje ekibindeki kişilerden ve onların yakınlarından; aile, arkadaş veya gönüllülerden dijital yollarla fon toplanması sürecini yürütmek.
...
- Literatür sorumlusunun bulduğu akademik verilerle bilimsel kurallara uygun poster/bildiri tasarımının yapılması ve 12. haftadaki sunumun grafik, dekont ve tablolar kullanılarak dizgilenmesi, slaytın sunumunun yapılması.
